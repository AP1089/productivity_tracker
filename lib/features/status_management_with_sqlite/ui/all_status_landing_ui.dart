...
import 'package:click_up/features/status_management_with_sqlite/ui/status_tasks_ui.dart';
...
class _AllStatusLandingUIState extends State<AllStatusLandingUI> {
  StatusManagementWithSQLiteBloc _bloc;

  @override
  void initState() {
    super.initState();
    _bloc = BlocProvider.of<StatusManagementWithSQLiteBloc>(context);
  }
  ...
  Widget _buildStatusCard(SingleStatusModel statusCardModel) {
    return GestureDetector(
      onTap: () {
        _bloc.updateSelectedStatusPipe.sink.add(statusCardModel);
        Navigator.push(
            context,
            MaterialPageRoute(
